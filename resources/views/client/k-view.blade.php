...
<div class="bg-light z-in-1 py-3 font-12">
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0 p-0 title-5 text-uppercase">
...
<meta property="og:url" content="{{ url('category')}}/{{ $data->slug }}" />
<meta property="og:image" content="{{ $data->img }}" />
<meta property="og:description" content="Dapatkan produk sci paint sesuai kebutuhan cat untuk rumah anda, berikut cat dengan kategori {{ $data->judul }}." />
